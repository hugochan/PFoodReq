...
class PBOWnetAgent(object):
    ...
    def __init__(self, opt, ctx_stops, vocab2id):
        ...
        self.model = BOWnet(opt['vocab_size'], opt['vocab_embed_size'],
                                        constraint_mark_emb=opt.get('constraint_mark_emb'), \
                                        word_emb_dropout=opt['word_emb_dropout'], \
                                        pre_w2v=pre_w2v, use_cuda=opt['cuda'])
        if opt['cuda']:
            self.model.cuda()
        ...
        super(PBOWnetAgent, self).__init__()
    ...
    def save(self, path=None):
        ...
        if path:
            ...
            checkpoint['bownet_optim'] = self.optimizer.state_dict()
    ...
    def load(self, path):
        ...
        self.optimizer.load_state_dict(checkpoint['bownet_optim'])
