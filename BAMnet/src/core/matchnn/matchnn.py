...
class MatchNNAgent(object):
    ...
    def __init__(self, opt, ctx_stops, vocab2id):
        ...
        self.model = MatchNN(opt['vocab_size'], opt['vocab_embed_size'], \
        ...
        super(MatchNNAgent, self).__init__()
    ...
    def train_step(self, xs, ys, step, is_training=True):
        ...
        with torch.set_grad_enabled(is_training):
            ...
            mem_hop_scores = self.model(selected_memories, queries, query_marks, query_lengths, query_words, ctx_mask=None)
            # Set margin
    ...
    def save(self, path=None):
        ...
        if path:
            checkpoint = {}
            checkpoint['matchnn'] = self.model.state_dict()
            checkpoint['matchnn_optim'] = self.optimizer.state_dict()
    ...
    def load(self, path):
        ...
        self.model.load_state_dict(checkpoint['matchnn'])
        self.optimizer.load_state_dict(checkpoint['matchnn_optim'])
